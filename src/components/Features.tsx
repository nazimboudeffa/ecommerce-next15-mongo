    ...
    return (
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            >
                ...
                <h2 className="mt-4 text-xl font-bold text-white">Create a store</h2>

                <p className="mt-1 text-sm text-gray-300">
                We help you create a store.
                </p>
            </div>
            ...
            >
                ...
                <h2 className="mt-4 text-xl font-bold text-white">Share your store</h2>

                <p className="mt-1 text-sm text-gray-300">
                Stay visible on our network and Internet.
                </p>
            </div>
            ...
            >
                ...
                <h2 className="mt-4 text-xl font-bold text-white">Sell online</h2>
