            ...
            <div className="flex items-center gap-4">
                {session ? (
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={()=>{}} className="btn btn-primary rounded-full px-5 py-2.5 text-sm font-medium mr-1">
                            Logout
                        </button>
                    </div>
                    ) : (
                <div className="sm:flex sm:gap-4">
                <Link href="/auth/sign-in" className="btn btn-primary rounded-full px-5 py-2.5 text-sm font-medium mr-1">
                    Login
                </Link>
                </div>
                )}
